...
const interviewReportSchema = z.object({
    ...
    .array(
      z.object({
        ...
        tasks: z
          .array(z.string())
          .describe(
            "List of tasks to be done on this day to follow the preparation plan, e.g. read a specific book",
          ),
      }),
    )
  ...
  title: z
    .string()
    .describe("The job title for which this interview report was generated"),
});
...

{
  ...
  "title":{the title of the job for which the interview report was generated}
}
...
async function generateInterviewReport({
  ...
  try {
    ...
    if (err instanceof z.ZodError) {
      console.error(
        "❌ Zod validation failed — AI response did not match schema:",
      );
