          ...
          <div className="flex-1 flex flex-col lg:flex-row overflow-hidden px-8 pb-8 gap-6">
            ...
            <aside className="w-[320px] flex-shrink-0 flex flex-col gap-6 overflow-y-auto hide-scrollbar">
              ...
              <div className="bg-white/60 backdrop-blur-xl rounded-[2rem] p-8 shadow-xl border border-white text-center relative overflow-hidden group">
                ...
                <div className="mt-6 px-4 py-2 rounded-xl inline-flex font-black text-sm uppercase tracking-wide border shadow-sm" 
                     style={{ color: scoreColor, borderColor: scoreColor, background: `${scoreColor}10` }}>
                  {scoreLabel}
                </div>
              </div>
